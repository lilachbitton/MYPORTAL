    ...
    try {
      ...
      const lessonData = {
        ...
        assignment: {
          ...
          content: newLesson.assignment.content || '',
...
<input
            ...
            {/* חלק המשימה החדש עם העורך */}
            <div className="border-t pt-4 mb-4">
              <h3 className="font-bold mb-2">פרטי המטלה</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block mb-1">תוכן המטלה:</label>
                  <RichTextEditor
                    value={newLesson.assignment.content}
                    onChange={(content) => setNewLesson({
                      ...newLesson,
                      assignment: { ...newLesson.assignment, content }
                    })}
                  />
                </div>
